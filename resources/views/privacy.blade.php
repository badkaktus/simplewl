<x-app-layout>
    <div class="mx-12">
        ...
        <p class="my-4 text-gray-500">This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your
            ...
            You.</p>
        <p class="my-4 text-gray-500">We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
            collection
            ...
            help of the <a href="https://www.privacypolicies.com/privacy-policy-generator/" target="_blank">Privacy
                Policy
                Generator</a>.</p>
        <h2 class="text-4xl font-extrabold dark:text-white">Interpretation and Definitions</h2>
        <h3 class="text-3xl font-bold dark:text-white">Interpretation</h3>
        <p class="my-4 text-gray-500">The words of which the initial letter is capitalized have meanings defined under the following conditions.
            The
            following definitions shall have the same meaning regardless of whether they appear in singular or in
            plural.</p>
        <h3 class="text-3xl font-bold dark:text-white">Definitions</h3>
        <p class="my-4 text-gray-500">For the purposes of this Privacy Policy:</p>
        <ul class="space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
            ...
            <li>
                <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                    or &quot;Our&quot; in this Agreement) refers to Simple wishlist.
            </li>
            <li>
            ...
            <li>
               <strong>Website</strong> refers to Simple wishlist, accessible from <a href="https://simplewl.com"
                                                                                          rel="external nofollow noopener"
                                                                                          target="_blank">https://simplewl.com</a>
        ...
        <h2 class="text-4xl font-extrabold dark:text-white">Collecting and Using Your Personal Data</h2>
        <h3 class="text-3xl font-bold dark:text-white">Types of Data Collected</h3>
        <h4 class="text-2xl font-bold dark:text-white">Personal Data</h4>
        <p class="my-4 text-gray-500">While using Our Service, We may ask You to provide Us with certain personally identifiable information that
            can
        ...
        <h4 class="text-2xl font-bold dark:text-white">Usage Data</h4>
        <p class="my-4 text-gray-500">Usage Data is collected automatically when using the Service.</p>
        <p class="my-4 text-gray-500">Usage Data may include information such as Your Device's Internet Protocol address (e.g. IP address), browser
        ...
        <p class="my-4 text-gray-500">When You access the Service by or through a mobile device, We may collect certain information automatically,
        ...
        <p class="my-4 text-gray-500">We may also collect information that Your browser sends whenever You visit our Service or when You access the
            Service by or through a mobile device.</p>
        <h4 class="text-2xl font-bold dark:text-white">Tracking Technologies and Cookies</h4>
        <p class="my-4 text-gray-500">We use Cookies and similar tracking technologies to track the activity on Our Service and store certain
        ...
        <p class="my-4 text-gray-500">Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your
            personal
        ...
        <p class="my-4 text-gray-500">We use both Session and Persistent Cookies for the purposes set out below:</p>
        <ul class="space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
            <li>
        ...
        <p class="my-4 text-gray-500">For more information about the cookies we use and your choices regarding cookies, please visit our Cookies
            Policy
            or the Cookies section of our Privacy Policy.</p>
        <h3 class="text-3xl font-bold dark:text-white">Use of Your Personal Data</h3>
        <p class="my-4 text-gray-500">The Company may use Personal Data for the following purposes:</p>
        <ul class="space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
            <li>
        ...
        <p class="my-4 text-gray-500">We may share Your personal information in the following situations:</p>
        <ul class="space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
        ...
        <h3 class="text-3xl font-bold dark:text-white">Retention of Your Personal Data</h3>
        <p class="my-4 text-gray-500">The Company will retain Your Personal Data only for as long as is necessary for the purposes set out in this
            Privacy Policy. We will retain and use Your Personal Data to the extent necessary to comply with our legal
            obligations (for example, if we are required to retain your data to comply with applicable laws), resolve
            disputes, and enforce our legal agreements and policies.</p>
        <p class="my-4 text-gray-500">The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for
            a
        ...
        <h3 class="text-3xl font-bold dark:text-white">Transfer of Your Personal Data</h3>
        <p class="my-4 text-gray-500">Your information, including Personal Data, is processed at the Company's operating offices and in any other
        ...
        <p class="my-4 text-gray-500">Your consent to this Privacy Policy followed by Your submission of such information represents Your agreement
            to
            that transfer.</p>
        <p class="my-4 text-gray-500">The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in
            ...
            information.</p>
        <h3 class="text-3xl font-bold dark:text-white">Delete Your Personal Data</h3>
        <p class="my-4 text-gray-500">You have the right to delete or request that We assist in deleting the Personal Data that We have collected
            about
            You.</p>
        <p class="my-4 text-gray-500">Our Service may give You the ability to delete certain information about You from within the Service.</p>
        <p class="my-4 text-gray-500">You may update, amend, or delete Your information at any time by signing in to Your Account, if you have one,
            and
        ...
        <p class="my-4 text-gray-500">Please note, however, that We may need to retain certain information when we have a legal obligation or
            lawful
            basis to do so.</p>
        <h3 class="text-3xl font-bold dark:text-white">Disclosure of Your Personal Data</h3>
        <h4 class="text-2xl font-bold dark:text-white">Business Transactions</h4>
        <p class="my-4 text-gray-500">If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We
            will
            provide notice before Your Personal Data is transferred and becomes subject to a different Privacy
            Policy.</p>
        <h4 class="text-2xl font-bold dark:text-white">Law enforcement</h4>
        <p class="my-4 text-gray-500">Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so
            by
            law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
        <h4 class="text-2xl font-bold dark:text-white">Other legal requirements</h4>
        <p class="my-4 text-gray-500">The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
        <ul class="space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
        ...
        <h3 class="text-3xl font-bold dark:text-white">Security of Your Personal Data</h3>
        <p class="my-4 text-gray-500">The security of Your Personal Data is important to Us, but remember that no method of transmission over the
            Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable
            means
            to protect Your Personal Data, We cannot guarantee its absolute security.</p>
        <h2 class="text-4xl font-extrabold dark:text-white">Children's Privacy</h2>
        <p class="my-4 text-gray-500">Our Service does not address anyone under the age of 13. We do not knowingly collect personally identifiable
        ...
        <p class="my-4 text-gray-500">If We need to rely on consent as a legal basis for processing Your information and Your country requires
            consent
            from a parent, We may require Your parent's consent before We collect and use that information.</p>
        <h2 class="text-4xl font-extrabold dark:text-white">Links to Other Websites</h2>
        <p class="my-4 text-gray-500">Our Service may contain links to other websites that are not operated by Us. If You click on a third party
            link,
            You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of
            every
            site You visit.</p>
        <p class="my-4 text-gray-500">We have no control over and assume no responsibility for the content, privacy policies or practices of any
            third
            party sites or services.</p>
        <h2 class="text-4xl font-extrabold dark:text-white">Changes to this Privacy Policy</h2>
        <p class="my-4 text-gray-500">We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new
            Privacy
            Policy on this page.</p>
        <p class="my-4 text-gray-500">We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming
            effective
            and update the &quot;Last updated&quot; date at the top of this Privacy Policy.</p>
        <p class="my-4 text-gray-500">You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy
            are
            effective when they are posted on this page.</p>
        <h2 class="text-4xl font-extrabold dark:text-white">Contact Us</h2>
        <p class="my-4 text-gray-500">If you have any questions about this Privacy Policy, You can contact us:</p>
        <ul class="space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
            <li>By email: info@simplewl.com</li>
        </ul>
    </div>
</x-app-layout>
